  ...
  <q-page padding>
  	<div class="form q-mb-lg">
	  	...
	  	<div class="row q-mb-md">
	  		...
	  		<label class="error" v-show="age > 100">Please enter an age between 1 - 100</label>
		  </div>
		  <div class="row">
  	...
  	<div class="description q-mb-lg" v-if="name.length && age">
  		...
  		<p>In 10 years I will be <b>{{ computeAge }}</b>.</p>
	...
	export default {
		...
		methods: {
				generateRandomPerson() {
					this.name = this.randNameArray[this.getRandomInt(this.randNameArray.length)].name;
					this.age =this.getRandomInt(100) + 1;
				},
				getRandomInt(max){
